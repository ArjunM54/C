/*
1.A City Bus is a Ring Route Bus which runs in circular fashion. That is, Bus once starts at the 
Source Bus Stop, halts at each Bus Stop in its Route and at the end it reaches the Source Bus Stop again.
...
void main()
{
    ...
    char BusStops[][3] = { "TH", "GA", "IC", "HA", "TE", "LU", "NI", "CA" };
    int len = sizeof(BusStops)/sizeof(BusStops[0]);
